...
Gem::Specification.new do |spec|
  ...
  spec.authors = ['SolidRail Team']
  spec.email = ['team@solidrail.dev']
  ...
  spec.homepage = 'https://github.com/solidrail/solidrail'
  spec.license = 'MIT'
  spec.required_ruby_version = '>= 3.0.0'

  spec.metadata['homepage_uri'] = spec.homepage
  spec.metadata['source_code_uri'] = 'https://github.com/solidrail/solidrail'
  spec.metadata['changelog_uri'] = 'https://github.com/solidrail/solidrail/blob/main/CHANGELOG.md'
  spec.metadata['bug_tracker_uri'] = 'https://github.com/solidrail/solidrail/issues'
